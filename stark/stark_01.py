...
def imprimir_lista_superheroes(lista):
    ...
    for i in range(len(lista)): 
        ...
        mensaje += f'El superheroe es {nombre}, su identidad es {identidad}, trabaja en {empresa}. \n En cuanto a su altura, mide {altura}, su peso es {peso}, es de genero {genero}. \n Tiene pelo {color_pelo}, sus ojos son {color_ojos}. \n Su fuerza es {fuerza} y su inteligencia es {inteligencia}. \n'
...
def peso_promedio_de_sh_masculinos(lista):
    ...
    if contador != 0:
        promedio = acumulador_peso_masculino/contador
